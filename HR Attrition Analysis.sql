...
--USING BULK INSERT TO DATA

BULK INSERT employees
FROM'C:\Users\DELL\Downloads\HR_Attrition_dataset.csv'
    WITH (
        FIRSTROW=2,
        FIELDTERMINATOR=',',
        ROWTERMINATOR='\n'
 ...
 --Suppose in future if there is hiring process we can update in existing table

 --Updating table in SQL server, it can also reflect in Power BI Dashboard for visualizing
...
---5 new records updated in database